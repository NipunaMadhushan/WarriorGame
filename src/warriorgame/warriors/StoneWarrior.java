...
public class StoneWarrior implements Warrior {
    ...
    public StoneWarrior(int gridRows, int gridColumns, int row, int column, int id, String type, int age, float health, float offensePower,
    ...
    private void activateSpecialAbility() {
        specialAbility = true;
        abilityDefenseStrength = Math.max(95, defenseStrength);
        health -= 3;
