...
public class AirWarrior implements Warrior {

    String displayString = "A";
    // Attributes
    int id;
    int age;
    float health;
    ...
    public AirWarrior(int gridRows, int gridColumns, int row, int column, int id, String type, int age, float health, float offensePower,
    ...
    private void activateSpecialAbility() {
        specialAbility = true;
        offensePower = Math.min(100, offensePower + 30);
